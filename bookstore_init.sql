...
-- ----------------------------
BEGIN;
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (1, '1', 'Java核心技术卷II', '编程', '凯S.霍斯特曼', 95.20, '本书是Java领域有影响力和价值的著作之一，由拥有20多年教学与研究经验的Java技术专家撰写（获Jolt大奖），与《Java编程思想》齐名，10余年全球畅销不衰，广受好评。第10版根据JavaSE8全面更新，同时修正了第9版中的不足，系统全面讲解了Java语言的核心概念、语法、重要特性和开发方法，包含大量案例，实践性强。', 895, 'http://img3m9.ddimg.cn/12/36/1546133799-1_w_1.jpg');
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (2, '2', '深入理解计算机系统', '编程', '兰德尔·E·布莱恩特', 136.90, '程序员必读经典著作！理解计算机系统*书目，10万程序员共同选择。第二版销售突破100000册，第三版重磅上市！', 1189, 'http://img3m7.ddimg.cn/48/0/24106647-1_w_6.jpg');
...
-- ----------------------------
BEGIN;
INSERT INTO `cartItem` (`bookAmount`, `cartItemID`, `isbn`, `cartID`) VALUES (1, 3, '1', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (1, 137, '2', 5, 1);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (2, 95, '1', 3, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orders` (`orderID`, `userID`, `orderDate`) VALUES (1, 1, '2023-06-30');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` (`userID`, `nickname`, `username`, `tel`, `address`, `password`, `type`) VALUES (1, 'nick1', 'user1', 'tel1', 'address1', '1', 1);
INSERT INTO `user` (`userID`, `nickname`, `username`, `tel`, `address`, `password`, `type`) VALUES (2, 'nick2', 'user2', 'tel2', 'address2', '2', 2);
COMMIT;
