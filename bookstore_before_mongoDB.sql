/*
 ...
 Date: 30/12/2023 23:13:37
*/

-- 创建数据库（如果不存在的话）
CREATE DATABASE IF NOT EXISTS `SingleBookstore` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (1, '1', 'Java核心技术卷II', '编程', '凯S.霍斯特曼', 95.20, '本书是Java领域有影响力和价值的著作之一，由拥有20多年教学与研究经验的Java技术专家撰写（获Jolt大奖），与《Java编程思想》齐名，10余年全球畅销不衰，广受好评。第10版根据JavaSE8全面更新，同时修正了第9版中的不足，系统全面讲解了Java语言的核心概念、语法、重要特性和开发方法，包含大量案例，实践性强。', 864, 'http://img3m9.ddimg.cn/12/36/1546133799-1_w_1.jpg');
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (2, '2', '深入理解计算机系统', '编程', '兰德尔·E·布莱恩特', 136.90, '程序员必读经典著作！理解计算机系统*书目，10万程序员共同选择。第二版销售突破100000册，第三版重磅上市！', 1187, 'http://img3m7.ddimg.cn/48/0/24106647-1_w_6.jpg');
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (3, '3', 'Effective C++', '编程', '梅耶', 51.30, '大师名著纵横二十载，稳居任一荐书单三甲；称职程序员傍身绝学，通向C++精微奥妙之门。', 978, 'http://img3m6.ddimg.cn/96/25/21000966-1_u_12.jpg');
INSERT INTO `book` (`id`, `isbn`, `name`, `type`, `author`, `price`, `description`, `inventory`, `image`) VALUES (4, '4', '小王子', '儿童文学', '圣-埃克苏佩里', 8.89, '豆瓣9.7高分推荐！旅法翻译家梅子涵之女梅思繁法文直译，舒朗大开本，央美教授高精度还原原作插画。首次收录全球舞台剧、音乐会、电影、动画片等对《小王子》的精彩诠释，通晓名作的前世今生。', 983, 'http://img3m9.ddimg.cn/75/6/25067469-1_u_2.jpg');
...
INSERT INTO `cart` (`cartID`, `userID`) VALUES (2, 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (1, 95, '1', 5, 1);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (2, 51, '3', 5, 1);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (3, 51, '3', 5, 2);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (4, 9, '4', 5, 2);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (5, 95, '1', 5, 3);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (6, 95, '1', 3, 5);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (7, 95, '1', 8, 7);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (8, 9, '4', 3, 8);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (9, 95, '1', 3, 9);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (10, 95, '1', 3, 10);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (11, 137, '2', 2, 11);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (12, 137, '2', 5, 12);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (13, 95, '1', 2, 13);
INSERT INTO `orderItem` (`orderItemID`, `currentPrice`, `isbn`, `bookAmount`, `orderID`) VALUES (14, 95, '1', 7, 14);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (1, 1, '2023-09-24 00:00:00');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (2, 1, '2023-09-24 13:51:44');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (3, 1, '2023-09-29 17:30:55');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (5, 1, '2023-10-01 11:36:26');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (7, 1, '2023-10-01 13:48:51');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (8, 1, '2023-10-01 13:52:16');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (9, 1, '2023-11-10 19:07:11');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (10, 1, '2023-11-10 19:10:08');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (11, 1, '2023-11-10 19:12:54');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (12, 1, '2023-11-11 04:02:02');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (13, 1, '2023-12-23 21:18:57');
INSERT INTO `orders` (`orderID`, `userID`, `dateTime`) VALUES (14, 1, '2023-12-24 06:00:53');
COMMIT;
...
INSERT INTO `user` (`userID`, `username`, `password`, `type`, `email`) VALUES (2, 'wlf2', '123456', 1, NULL);
COMMIT;
